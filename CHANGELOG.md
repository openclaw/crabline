...
- Serialize recorder persistence, secure OpenClaw smoke artifacts with stable file identities, renewable PID-reuse-aware lock leases, bounded cleanup retries, and platform-native permissions, and enforce strict QA target and recorder normalization.
