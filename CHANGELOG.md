...
- Revalidate recorder hardlink identities, persist parent-directory durability on every append, keep paused live recorder owners from losing their locks, and enforce owner-only Windows lock roots.
