...
- Serialize recorder persistence, secure OpenClaw smoke artifacts with retriable cross-process locks and platform-native file permissions, and enforce strict QA target and recorder normalization.
