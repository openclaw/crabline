...
- Revalidate recorder hardlink identities, persist parent-directory durability on every append, recover recycled recorder-owner PIDs without stealing live locks, and enforce owner-only Windows lock roots.
