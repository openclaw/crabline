...
- Serialize recorder persistence, secure OpenClaw smoke artifacts with bounded lock-cleanup retries and platform-native file permissions, and enforce strict QA target and recorder normalization.
