...
- Serialize recorder persistence, secure complete OpenClaw smoke artifact sets with caller-held renewable locks, stable file identities, bounded cleanup retries, and platform-native permissions, and enforce strict QA target and recorder normalization.
